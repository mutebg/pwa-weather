...
class Navigation extends Component {
		...
		this.items = [
			{
				...
				icon: (
					...
					>
						...
						<path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0
			...
			},
			{
				...
				icon: (
					<svg
						...
						xmlns="http://www.w3.org/2000/svg"
					>
						<path d="M4 14h4v-4H4v4zm0 5h4v-4H4v4zM4 9h4V5H4v4zm5 5h12v-4H9v4zm0
                5h12v-4H9v4zM9 5v4h12V5H9z"
						/>
						<path d="M0 0h24v24H0z" fill="none" />
					</svg>
				)
	...
	render(props) {
		const navItems = this.items.map(item => (
			<a
				class={`Navigation__item ${props.currentURL === item.link
		...
		return <div class="Navigation">{navItems}</div>;
	}
}
